...
class TestText(TestCase):
    ...
    def test_escape_tex(self):
        ...
        for value, output in items:
            self.assertEqual(html2latex.utils.text.escape_tex(value), output)
    ...
    def test_unescape_latex(self):
        ...
        for value, output in items:
            self.assertEqual(
                html2latex.utils.text.unescape_latex(output), value)
    ...
    def test_escape_latex(self):
        ...
        for value, output in items:
            self.assertEqual(html2latex.utils.text.escape_latex(value), output)
