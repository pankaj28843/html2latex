...
Originally a **Python 2.7** library to convert HTML (generated by rich text editors like TinyMCE/CKEditor) into LaTeX markup. It is now being modernized for **Python 3**. The initial version was developed between **2014** and **2016** as part of the [ClassKlap](https://www.classklap.com) publishing workflow for K-12 educational content. The Xamcheck brand and website have since been retired.
...
- **Features**:
  - Converts common WYSIWYG HTML tags and inline styles into LaTeX (see `docs/html-tag-mapping.md`).
  - Supports blockquote, pre/code, figure/figcaption, tables, lists, and links.
  - Handles table merges, cell spans, and image scaling (LaTeX-native tables; no screenshot pipeline).
...
- **Caveats**:
  ...
  5. Some LaTeX constructs require specific packages (see the section below).
...
To compile LaTeX generated by HTML2LaTeX, install the required packages listed in `docs/html-tag-mapping.md`.
Common requirements include:

- `hyperref` (links)
- `graphicx` (images)
- `xcolor` with table support (color + table styles)
- `ulem` (strike-through)
- `enumitem` (list formatting)
- `tabularx`, `array`, `multirow` (tables)
...
- HTML→LaTeX mapping spec: `docs/html-tag-mapping.md`
